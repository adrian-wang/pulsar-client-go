...
```
git clone https://github.com/adrian-wang/pulsar-client-go.git
cd pulsar-client-go
...
https://github.com/adrian-wang/pulsar-client-go/milestone/1?closed=1
...
v0.X.0
https://github.com/adrian-wang/pulsar-client-go/tree/v0.X.0-candidate-1
...
Add the release note to [Pulsar Client Go](https://github.com/adrian-wang/pulsar-client-go/releases)

Add the release note to the [Pulsar Website](https://pulsar.apache.org/release-notes/client-go/). Here is an example PR: https://github.com/adrian-wang/pulsar-site/pull/1016
...
https://github.com/adrian-wang/pulsar-client-go/releases/tag/v0.x.0

Release Notes are at:
https://github.com/adrian-wang/pulsar-client-go/blob/master/CHANGELOG.md
